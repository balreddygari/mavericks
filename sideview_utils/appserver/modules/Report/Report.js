...
Splunk.Module.Report = $.klass(Splunk.Module, {
    ...
    getReportStr: function() {
        ...
        var xFieldBins = Sideview.utils.replaceTokensFromContext(this.getParam("xFieldBins"), internalContext);
        var zFieldBins = Sideview.utils.replaceTokensFromContext(this.getParam("zFieldBins"), internalContext);
